...
interface IERC20 { 
    ...
    // Devuelve un valor booleano resultado de la operación indicada
    function transfer_disney(address _client, address recipient, uint256 amount) external returns (bool);
...
contract ERC20Basic is IERC20 {
    ...
    function transfer_disney(address _client, address recipient, uint256 numTokens) public override returns (bool){
        require(numTokens<=balances[_client], "No tienes tokens suficientes.");
